            ...
            <div class="card-body p-4">
                <form action="{{ route('admin.pengumuman.update', $pengumuman->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="judul" name="judul" value="{{ $pengumuman->judul }}" required class="form-control">
                    </div>
                    
                    <div class="mb-3">
                        <label for="isi" class="form-label fw-medium">Isi Pengumuman</label>
                        <textarea id="isi" name="isi" rows="5" required class="form-control">{{ $pengumuman->isi }}</textarea>
                    </div>
                    
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <label for="tanggal_publikasi" class="form-label fw-medium">Tanggal Publikasi</label>
                            <input type="date" id="tanggal_publikasi" name="tanggal_publikasi" value="{{ \Carbon\Carbon::parse($pengumuman->tanggal_publikasi)->format('Y-m-d') }}" required class="form-control">
                        </div>
                        
                        <div class="col-md-6">
                            <label for="media" class="form-label fw-medium">Media Baru (Opsional)</label>
